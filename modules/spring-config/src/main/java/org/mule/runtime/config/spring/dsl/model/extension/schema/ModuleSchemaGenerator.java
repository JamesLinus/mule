...
/**
 * //TODO WIP MULE-10252 class that given a {@link ModuleExtension} returns a schema as an stream when executing {@link #getSchema(ModuleExtension)}.
 * Ideally, once we rely the <module>s in {@link org.mule.runtime.api.meta.model.ExtensionModel}, the generation will be
 * not only consistent, but it will also imply this class must be deleted.
 */
